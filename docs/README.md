...
- `naming-conventions.md` — naming rules, booleans, collections
- `security.md` — secrets, input validation, least privilege
- `simplicity.md` — design simplicity, function size
- `testing.md` — unit vs integration, what to test
- `todos.md` — TODO format, no dead code
